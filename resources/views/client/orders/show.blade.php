    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            <h2 class="font-semibold text-xl text-blue-950 dark:text-blue-300 leading-tight">
                {{ __('Commande #') }}{{ $order->order_number }}
            </h2>
                        ...
                        <div class="divide-y divide-gray-200 dark:divide-gray-700">
                            @foreach($order->items as $item)
                                <div class="py-4 flex items-center">
                                    <img src="{{ $item->product->image }}" alt="{{ $item->name }}" class="w-16 h-16 object-cover rounded">
                            ...
                            <div class="space-y-2">
                                ...
                                <div class="border-t border-gray-200 dark:border-gray-600 pt-2 mt-2">
                                    <div class="flex justify-between font-semibold">
                                        ...
                                        <span class="text-gray-900 dark:text-gray-100">{{ number_format($order->total, 0, ',', ' ') }} FCFA</span>
                                    </div>
                                </div>
                            </div>
                        </div>
