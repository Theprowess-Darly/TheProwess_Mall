...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold text-blue-950 dark:text-blue-300">Mes Produits</h2>
        <a href="{{ route('vendor.products.create') }}" class="bg-blue-950 hover:bg-green-950  px-4 py-2 rounded-md transition-colors shadow-md flex items-center">
