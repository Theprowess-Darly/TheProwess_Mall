    ...
    <div class="bg-white dark:bg-gray-800 shadow-lg rounded-lg p-6">
        <form action="{{ route('vendor.products.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex justify-end">
                <button type="submit" class="px-4 py-2 bg-blue-950 text-white rounded-md hover:bg-green-950 focus:outline-none focus:ring-2 focus:ring-yellow-700 focus:ring-offset-2 transition-colors">
                    Ajouter le produit
                </button>
            </div>
        </form>
