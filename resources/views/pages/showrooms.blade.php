        ...
        <div class="container mx-auto max-w-7xl">
            ...
            <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                ...
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105">
                    <img src="{{ Vite::asset('resources/images/showrooms/showroom1.jpg') }}" alt="Douala Showroom" class="w-full h-48 object-cover">
                    <div class="p-6">
                ...
                <!-- Yaoundé Showroom -->
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105">
                    <img src="{{ Vite::asset('resources/images/showrooms/showroom3.jpg') }}" alt="Yaoundé Showroom" class="w-full h-48 object-cover">
                    <div class="p-6">
                ...
                <!-- Bafoussam Showroom -->
                <div class="bg-white rounded-lg shadow-lg overflow-hidden transform transition-all duration-300 hover:scale-105">
                    <img src="{{ Vite::asset('resources/images/showrooms/showroom2.jpg') }}" alt="Bafoussam Showroom" class="w-full h-48 object-cover">
                    <div class="p-6">
