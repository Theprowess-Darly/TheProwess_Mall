                ...
                <div class="grid md:grid-cols-4 justify-center gap-8">
                    ...
                    <div class="text-center">
                        <div class="w-32 h-32 mx-auto rounded-full bg-gray-200 mb-4 overflow-hidden">
                            <img loading="lazy" src="{{ asset('images/team/ceo.jpg') }}" alt="CEO" class="w-full h-full object-cover">
                        </div>
                    ...
                    <div class="text-center">
                        <div class="w-32 h-32 mx-auto rounded-full bg-gray-200 mb-4 overflow-hidden">
                            <img loading="lazy" src="{{ asset('images/team/memorial.jpg') }}" alt="CEO" class="w-full h-full object-cover">
                        </div>
                    ...
                    <div class="text-center">
                        <div class="w-32 h-32 mx-auto rounded-full bg-gray-200 mb-4 overflow-hidden">
                            <img loading="lazy" src="{{ asset('images/team/adviser.jpg') }}" alt="CEO" class="w-full h-full object-cover">
                        </div>
