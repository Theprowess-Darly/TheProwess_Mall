        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
                ...
                <div class="bg-white dark:bg-gray-700 overflow-hidden shadow-md border-l-4 border-yellow-500 dark:border-yellow-500 rounded-lg p-6 transition-all duration-300 hover:shadow-lg">
                    <div class="text-gray-900 dark:text-gray-100">
                        <div class="flex justify-between items-center">
                            <h3 class="text-lg font-semibold text-green-950 dark:text-green-300">En attente</h3>
                        ...
                        <p class="text-3xl font-bold mt-2 text-green-800 dark:text-white">{{ $pendingDeliveries ?? 0 }}</p>
                ...
                <div class="bg-white dark:bg-gray-700 overflow-hidden shadow-md border-l-4 border-blue-500 dark:border-blue-500 rounded-lg p-6 transition-all duration-300 hover:shadow-lg">
                    <div class="text-gray-900 dark:text-gray-100">
                        <div class="flex justify-between items-center">
                            <h3 class="text-lg font-semibold text-green-950 dark:text-green-300">En cours</h3>
                        ...
                        <p class="text-3xl font-bold mt-2 text-green-800 dark:text-white">{{ $inProgressDeliveries ?? 0 }}</p>
                ...
                <div class="bg-white dark:bg-gray-700 overflow-hidden shadow-md border-l-4 border-green-500 dark:border-green-500 rounded-lg p-6 transition-all duration-300 hover:shadow-lg">
                    <div class="text-gray-900 dark:text-gray-100">
                        <div class="flex justify-between items-center">
                            <h3 class="text-lg font-semibold text-green-950 dark:text-green-300">Complétées</h3>
                        ...
                        <p class="text-3xl font-bold mt-2 text-green-800 dark:text-white">{{ $completedDeliveries ?? 0 }}</p>
            ...
            <div class="bg-white dark:bg-gray-700 overflow-hidden shadow-md rounded-lg p-6 mb-8">
                <h3 class="text-lg font-semibold text-green-950 dark:text-green-300 mb-4 border-b border-gray-200 dark:border-gray-600 pb-2">Carte des livraisons</h3>
                <div class="h-96 bg-gray-200 dark:bg-gray-800 rounded-lg flex items-center justify-center">
                    <!-- Replace with actual map implementation -->
                    <p class="text-gray-500 dark:text-gray-400">Carte des livraisons en cours</p>
                </div>
            </div>
            ...
            <div class="bg-white dark:bg-gray-700 overflow-hidden shadow-md rounded-lg p-6 mb-8">
                <div class="flex justify-between items-center mb-4 border-b border-gray-200 dark:border-gray-600 pb-2">
                    <h3 class="text-lg font-semibold text-green-950 dark:text-green-300">Livraisons actuelles</h3>
                    ...
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-600">
                        <thead class="bg-green-50 dark:bg-gray-800">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-green-800 dark:text-green-300 uppercase tracking-wider">Adresse</th>
            ...
            <div class="bg-white dark:bg-gray-700 overflow-hidden shadow-md rounded-lg p-6">
                <div class="flex justify-between items-center mb-4 border-b border-gray-200 dark:border-gray-600 pb-2">
                    <h3 class="text-lg font-semibold text-green-950 dark:text-green-300">Historique des livraisons</h3>
                    <a href="#" class="text-sm text-green-600 dark:text-green-400 hover:underline">Voir tout</a>
                </div>
                            ...
                            <div class="flex items-center space-x-3">
                                <div class="flex-shrink-0">
                                    <div class="w-10 h-10 rounded-full bg-green-100 dark:bg-green-900 flex items-center justify-center">
                                        <span class="text-green-800 dark:text-green-200 font-medium">#{{ $history->id }}</span>
                                    </div>
                                </div>
                                <div>
