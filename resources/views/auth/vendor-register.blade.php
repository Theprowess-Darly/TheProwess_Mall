        ...
        <div class="mt-4">
            <label for="terms" class="inline-flex items-center">
                ...
                <span class="ml-2 text-sm text-gray-600">
                    {{ __('J\'accepte la') }} 
                    <a href="{{ route('privacy-policy') }}" class="text-indigo-600 hover:underline" target="_blank">{{ __('politique de confidentialité') }}</a>
                    {{ __('et les') }}
                    <a href="{{ route('terms-of-sale') }}" class="text-indigo-600 hover:underline" target="_blank">{{ __('conditions générales de vente') }}</a>
                </span>
            </label>
