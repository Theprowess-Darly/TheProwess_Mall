<div class="min-h-screen bg-purple-950 dark:bg-gray-900 text-white w-64 fixed left-0 top-0 z-40 transition-all duration-300 ease-in-out" id="sidebar">
    ...
    <div class="py-4">
        ...
        <nav class="mt-2">
            ...
            <a href="{{ route('delivery.earnings.index') }}" class="flex items-center px-4 py-3 {{ request()->routeIs('delivery.earnings.*') ? 'bg-purple-800 dark:bg-gray-800 text-white' : 'text-purple-200 dark:text-gray-300 hover:bg-purple-800 dark:hover:bg-gray-800 hover:text-white' }} transition-colors duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
